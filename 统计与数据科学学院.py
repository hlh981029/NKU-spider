...
urls = [
    'http://stat.nankai.edu.cn/_wp3services/generalQuery?queryObj=teacherHome'
]
...
form_data = [
    {
        'siteId': '127',
        'pageIndex': '1',
        'conditions': '[{"orConditions":[{"field":"exField1","value":"教授","judge":"="}]},{"field":"published","value":1,"judge":"="}]',
    ...
    },
    {
        'siteId': '127',
        'pageIndex': '1',
        'conditions': '[{"orConditions":[{"field":"exField1","value":"副教授","judge":"="}]},{"field":"published","value":1,"judge":"="}]',
        'orders': '[{"field":"letter","type":"asc"}]',
        'returnInfos': '[{"field":"title","name":"title"},{"field":"exField1","name":"exField1"},{"field":"exField2","name":"exField2"},{"field":"exField3","name":"exField3"},{"field":"exField4","name":"exField4"},{"field":"email","name":"email"},{"field":"phone","name":"phone"},{"field":"exField5","name":"exField5"},{"field":"exField6","name":"exField6"},{"field":"exField7","name":"exField7"},{"field":"headerPic","name":"headerPic"},{"field":"cnUrl","name":"cnUrl"}]',
        'articleType': '1',
        'level': '1'
    },
    {
        'siteId': '127',
        'pageIndex': '1',
        'conditions': '[{"orConditions":[{"field":"exField1","value":"讲师","judge":"="}]},{"field":"published","value":1,"judge":"="}]',
        'orders': '[{"field":"letter","type":"asc"}]',
        'returnInfos': '[{"field":"title","name":"title"},{"field":"exField1","name":"exField1"},{"field":"exField2","name":"exField2"},{"field":"exField3","name":"exField3"},{"field":"exField4","name":"exField4"},{"field":"email","name":"email"},{"field":"phone","name":"phone"},{"field":"exField5","name":"exField5"},{"field":"exField6","name":"exField6"},{"field":"exField7","name":"exField7"},{"field":"headerPic","name":"headerPic"},{"field":"cnUrl","name":"cnUrl"}]',
        'articleType': '1',
        'level': '1'
